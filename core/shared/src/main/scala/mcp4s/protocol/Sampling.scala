...
/** Sampling types for server-initiated LLM requests Spec ref:
  * https://modelcontextprotocol.io/specification/2025-11-25/client/sampling Spec ref: schema.ts
  * sampling/createMessage
  */

/** Content that can appear in sampling messages Includes text, image, audio, and tool use/result
  * blocks
  */
...
/** Tool use content for when the model wants to call a tool Spec ref: schema.ts ToolUseContent
  */
...
/** Tool result content for returning tool call results Spec ref: schema.ts ToolResultContent
  */
...
/** A message in a sampling conversation Spec ref: schema.ts SamplingMessage
  */
...
/** Model selection preferences Spec ref: schema.ts ModelPreferences
  */
...
/** Hint for model selection Spec ref: schema.ts ModelHint
  */
...
/** Result of sampling/createMessage Spec ref: schema.ts CreateMessageResult
  */
