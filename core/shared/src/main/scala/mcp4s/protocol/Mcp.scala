...
object ResourceUri:
  ...
  extension (uri: ResourceUri) def value: String = uri
...
object PromptName:
  ...
  extension (name: PromptName) def value: String = name

/** MCP Protocol version Spec ref:
...
/** Icon for UI display Spec ref: schema.ts Icon interface
  */
...
/** Annotations for content and resources Spec ref: schema.ts Annotations interface
  */
...
/** Server capabilities Spec ref: schema.ts ServerCapabilities
  */
...
/** Client capabilities Spec ref: schema.ts ClientCapabilities
  */
...
object JsonSchemaProperty:
  def make(
    ...
    JsonSchemaProperty(Some(`type`), description, `enum`, default, oneOf, enumNames, items, anyOf)
...
/** Tool annotations for AI safety hints Spec ref: schema.ts ToolAnnotations CRITICAL for AI safety
  * \- describes tool behavior to LLMs
  */
...
/** Task support for async tool execution Spec ref: schema.ts ToolExecution
  */
enum TaskSupport:
...
/** Tool definition Spec ref: schema.ts Tool interface
  */
...
/** Tool call result content types Spec ref: schema.ts ContentBlock union
  */
enum ContentType:
  case Text, Image, Audio, Resource, ResourceLink

/** Content in tool results Spec ref: schema.ts ContentBlock
  */
sealed trait Content:
  def `type`: ContentType

/** Text content Spec ref: schema.ts TextContent
  */
...
/** Image content (base64 encoded) Spec ref: schema.ts ImageContent
  */
...
/** Audio content (base64 encoded) Spec ref: schema.ts AudioContent
  */
...
/** Embedded resource content Spec ref: schema.ts EmbeddedResource
  */
...
/** Link to a resource without embedding Spec ref: schema.ts ResourceLink
  */
...
/** Result of a tool call Spec ref: schema.ts CallToolResult
  */
...
object ToolResult:
  ...
  def image(data: Array[Byte], mimeType: String): ToolResult =
    ToolResult(List(ImageContent(ByteVector(data).toBase64, mimeType)))

// === Resources ===
// Spec ref: https://modelcontextprotocol.io/specification/2025-11-25/server/resources

/** Resource definition Spec ref: schema.ts Resource
  */
...
/** Resource template for dynamic resources Spec ref: schema.ts ResourceTemplate
  */
...
/** Content of a resource Spec ref: schema.ts TextResourceContents | BlobResourceContents
  */
...
object ResourceContent:
  ...
  def binary(uri: String, data: Array[Byte], mimeType: String): ResourceContent =
    ResourceContent(uri, Some(mimeType), None, Some(ByteVector(data).toBase64))

// === Prompts ===
// Spec ref: https://modelcontextprotocol.io/specification/2025-11-25/server/prompts

/** Prompt argument definition Spec ref: schema.ts PromptArgument
  */
...
/** Prompt definition Spec ref: schema.ts Prompt
  */
...
/** Prompt message Spec ref: schema.ts PromptMessage
  */
...
/** Result of getting a prompt Spec ref: schema.ts GetPromptResult
  */
...
/** Initialize request params Spec ref: schema.ts InitializeRequest params
  */
...
/** Initialize response result Spec ref: schema.ts InitializeResult
  */
...
/** Parameters for cancellation notification Spec ref: schema.ts CancelledNotification
  */
...
/** Parameters for progress notification Spec ref: schema.ts ProgressNotification
  */
...
/** Root represents an accessible filesystem boundary Spec ref: schema.ts Root interface
  */
...
/** Result of listing roots Spec ref: schema.ts ListRootsResult
  */
