...
/** Context passed to tool handlers for advanced operations.
  *
  * Provides access to server-to-client capabilities like sampling, elicitation, progress reporting,
  * and logging within tool handlers.
  *
  * @example
  *   {{{
...
object ToolContext:
  ...
  /** Create a full tool context with all capabilities.
    *
    * @param sampler
    *   The sampling requester to use
    * @param eliciter
    *   The elicitation requester to use
    * @param reqId
    *   The request ID for progress reporting
    * @param progressToken
    *   Optional progress token from _meta (used instead of reqId for progress notifications)
    * @param progressFn
    *   Function to send progress notifications
    * @param loggingFn
    *   Function to send logging notifications
    */
  def apply[F[_]](
  ...
  final private class MinimalToolContext[F[_]](
