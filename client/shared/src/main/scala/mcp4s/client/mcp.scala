...
/** Unified DSL for MCP client construction.
  *
  * This object provides a single import (`import mcp4s.client.mcp.*`) that gives access to all DSL
  * constructors for building MCP clients with minimal boilerplate.
  *
  * Example usage:
  * {{{
