...
```scala
// Mill
mvn"io.github.mcp4s::mcp4s-server::0.1.5"
mvn"io.github.mcp4s::mcp4s-client::0.1.5"
...
|--------|---------|-------|
| `mcp4s-core` | Protocol types and codecs | [Protocol Reference](reference/protocol) |
| `mcp4s-server` | Server with DSL for tools, resources, prompts | [Server Guide](server/) |
| `mcp4s-client` | Client with resilience patterns | [Client Guide](client/) |
