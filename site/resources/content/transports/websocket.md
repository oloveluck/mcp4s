...
The WebSocket client transport handles connection lifecycle within the `Resource`. If the connection drops, the resource is released and must be re-acquired. For automatic reconnection, combine with the [resilience](../client/resilience) patterns.
