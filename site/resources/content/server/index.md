...
- [Tools](tools) — Callable functions for AI clients
- [Resources](resources) — Data exposed via URI
- [Prompts](prompts) — Reusable message templates
- [HTTP Security](auth) — Securing your server
