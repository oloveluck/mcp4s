...
The `@description` annotation adds documentation to the schema — this helps the AI understand what each parameter does. `Option` fields become optional in the schema.
...
The output schema is included in the tool definition, letting clients know the shape of the response. See [Type Derivation](../reference/type-derivation) for details.
